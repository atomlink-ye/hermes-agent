...
| `FEISHU_GROUP_POLICY` | Group access policy: `open`, `allowlist`, or `disabled` |
| `FEISHU_REQUIRE_MENTION` | When `true` (default), group chats require `@mention`; set to `false` to reply without mentions |
